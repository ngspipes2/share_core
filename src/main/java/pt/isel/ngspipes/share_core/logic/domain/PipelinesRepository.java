...
public class PipelinesRepository {
    ...
    public PipelinesRepository(int id, String name, String description, Date creationDate, boolean isPublic, User owner, Collection<Group> groupAccess, Collection<User> usersAccess) {
        this.id = id;
        this.name = name;
