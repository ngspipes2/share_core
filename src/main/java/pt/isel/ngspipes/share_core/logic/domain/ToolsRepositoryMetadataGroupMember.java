...
@Entity
@Table(name = "ToolsRepositoryMetadataGroupMember")
public class ToolsRepositoryMetadataGroupMember {
    ...
    public ToolsRepositoryMetadataGroupMember(int id, Date creationDate, Group group, ToolsRepositoryMetadata repository, boolean writeAccess) {
        this.id = id;
    ...
    public ToolsRepositoryMetadataGroupMember() { }
