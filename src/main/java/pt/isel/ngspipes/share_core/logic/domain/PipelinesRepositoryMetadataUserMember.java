...
@Entity
@Table(name = "PipelinesRepositoryMetadataUserMember")
public class PipelinesRepositoryMetadataUserMember {
    ...
    public PipelinesRepositoryMetadataUserMember(int id, Date creationDate, User user, PipelinesRepositoryMetadata repository, boolean writeAccess) {
        this.id = id;
    ...
    public PipelinesRepositoryMetadataUserMember() { }
